...
void MicrostructureAnalysis::WriteEBSDVTK(PhaseField& Phase, Crystallography& CR, const Settings& locSettings, EulerConventions locConvention, const int sd, const int tStep)
{
...
dVector3 MicrostructureAnalysis::FindValuePosition(const PhaseField& Phi, size_t index, double value, dVector3 start_position, dVector3 direction, double tolerance)
{
    direction.normalize();
