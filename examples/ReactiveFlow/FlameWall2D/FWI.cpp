...
{ 
    ...
    else 
    {
        ...
        ET.IF_ConstTemp.push_back(true); // true is constant temperature condition is applied at walls
        ET.SurfaceTemp.push_back(ET.TempSolid);
        ET.IF_ConstFlux.push_back(false); // true is heat flux condition is applied at walls
        ET.SurfaceFlux.push_back(ET.HeatFlux); 
    ...
    {   
        ...
        SB.writeData(OPSettings.TextDir,"Reynolds number", FL.U0X * FM.LengthScale / FM.InletViscosity);
