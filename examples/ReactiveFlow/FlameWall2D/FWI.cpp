...
int main(int argc, char *argv[])
{
    ...
    else
    {
        ...
        EN.ThermalSurfaceCondition.push_back({ThermalCondition::Type::ConstantTemp, EN.TempSolid, idx01[1], 0.0});
    ...
    if(Phase.Grid.OffsetX==0 and Phase.Grid.OffsetZ==0)
    {
        ...
        SB.writeData(OPSettings.TextDir,"Reynolds number", FL.U0X * MF.LengthScale / MF.InletViscosity);
