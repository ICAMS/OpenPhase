...
class OP_EXPORTS InterfaceProperties : public OPObject                          ///< Interface properties module.
{
 ...
 public:
    ...
    Table<InterfaceEnergyModel> InterfaceEnergy;                                ///< Interface energy model storage for all pairs of phases
    Table<InterfaceMobilityModel> InterfaceMobility;                            ///< Interface mobility model storage for all pairs of phases
 ...
 private:
    ...
    size_t MaxExtrapolationIterations;                                          ///< Maximum number of extrapolation iterations
    ...
    void SetEnergyToZeroAtHalo(const PhaseField& Phase);                       ///< Sets interface energy to zero at the halo regions
    bool ZerothOrderExtrapolation(const PhaseField& Phase);                     ///< Extrapolates the interface energy using Zeroth order approximation
