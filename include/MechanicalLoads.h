...
struct MechanicalLoadStructure
{
    ...
    MechanicalLoadStructure(void) :                                             ///< Default constructor
        ...
        ONtriggerValue(0.0),
        OFFtriggerValue(0.0),
        AppliedStrainMask(dVector6()),
        AppliedStressMask(dVector6()),
        AppliedStrainRateMask(dVector6()),
        AppliedStress(vStress()),
        AppliedStrain(vStrain()),
        AppliedStrainRate(vStrain())
    {
